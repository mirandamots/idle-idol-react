...
This generated README is ridiculous, so I'm hijacking the top of it for **installation instructions**.

Node.js is cool. [Get that here.](https://nodejs.org/en/) After that, getting
the build running is pretty simple; just run `npm start` from the project
directory, and that should build the project and launch the front page. Some
changes reflect automatically, others require a refresh. If you add a new
